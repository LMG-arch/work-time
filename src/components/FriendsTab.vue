...
.section-title { font-size: 13px; font-weight: 600; color: var(--text2); margin: 14px 10px 8px; }
.friend-section:first-child .section-title { margin-top: 6px; }

.friend-item { display: flex; align-items: center; justify-content: space-between; padding: 8px 10px; border-radius: 8px; margin: 2px 8px; background: var(--card); transition: background .15s; }
...
.friend-info .avatar-placeholder { width: 36px; height: 36px; border-radius: 50%; background: var(--accent); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 15px; font-weight: 600; flex-shrink: 0; }
...
.friend-btn.accept { background: var(--work); color: #fff; }
.friend-btn.reject { background: var(--danger); color: #fff; }

.friend-remove-btn { font-size: 18px; color: var(--text3); cursor: pointer; padding: 2px 6px; line-height: 1; flex-shrink: 0; }
.friend-remove-btn:hover { color: var(--danger); }

/* Add friend */
.add-friend-section { margin: 4px 8px; }
.add-friend-row { display: flex; gap: 6px; }
.add-friend-input { flex: 1; font-size: 13px; padding: 7px 10px; border: 1px solid var(--border); border-radius: 7px; outline: none; background: transparent; color: var(--text); box-sizing: border-box; }
.add-friend-input:focus { border-color: var(--accent); }
.add-friend-btn { font-size: 13px; padding: 7px 14px; border-radius: 7px; border: none; background: var(--accent); color: #fff; cursor: pointer; font-weight: 500; white-space: nowrap; }
.add-msg { font-size: 12px; margin-top: 4px; color: var(--work); }
.add-msg.error { color: var(--danger); }

.social-state { text-align: center; padding: 20px 10px; font-size: 13px; color: var(--text3); }
.empty-hint { margin: 4px 0 0; font-size: 12px; color: var(--text3); }
</style>
